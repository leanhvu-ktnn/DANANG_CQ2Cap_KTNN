...
```mermaid
flowchart TD
  CTDT["Chu truong dau tu"] --> QDDT["Quyet dinh dau tu"]
  QDDT --> KH["Lap TD PD giao KH DTC"]
  KH --> Von["QLSD von / thanh toan KBNN"]
  Von --> NT["Nghiem thu ban giao quyet toan"]
  NT --> GS["Theo doi danh gia KT TTra"]
```
